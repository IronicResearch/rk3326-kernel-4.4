...
//           
//             //register_value = Read_Reg(register_addr);
...
static ssize_t auto_SC7660_3_axis_Calibration(int x, int y, int z)
{
    ...
    sensor_write_reg(sc7660_client, 0x1e,0x05);
	mdelay(100);
	result = auto_calibration_instant_mtp(0,0,-64);
	mdelay(10);
    if(result )
   	{
        ...
        const char *buf, size_t count)
{
   // int address, value;
    ...
    result = sensor_write_reg(sc7660_client, 0x1e,0x05);
	mdelay(100);
    result = sensor_write_reg(sc7660_client, 0x13,0x00); 

    result = sensor_write_reg(sc7660_client, 0x1e,0x15);
	mdelay(300);
...
//	int err = -1;       
//	
//	err = sensor_write_reg(sc7660_client, SC7660_MODE, 0x77);
//	err = sensor_write_reg(sc7660_client, SC7660_MODE3, 0x08);//open BDU
//	
//	//register_test();  
//
//	return err;    
...
struct sensor_operate gsensor_sc7660_ops = {
	.name				= "gs_sc7660",
