...
#define EM3071_SUSPEND_LOCK_NAME "yj8316" 
static struct wake_lock em3071_suspend_lock; 
struct wake_lock		yj_wake_lock;
...
void rk808_set_swout2(int flag)
{
       u32  data;
       struct rk808 *rk808 = i2c_get_clientdata(rk808_i2c_client);
       regmap_read(rk808->regmap, 0xb4, &data);
		       ...
		       const struct i2c_device_id *id)
{
	...
	wake_lock_init(&yj_wake_lock, WAKE_LOCK_SUSPEND, "yjrt5640_bat_lock");

 wake_lock_init(&em3071_suspend_lock, WAKE_LOCK_SUSPEND, EM3071_SUSPEND_LOCK_NAME);
 wake_lock(&em3071_suspend_lock);
	return 0;
